...
```sh
curl -LO https://github.com/jbovet/tlschecker/releases/download/v0.1.13.2/tlschecker-linux
...
```sh
curl -LO https://github.com/jbovet/tlschecker/releases/download/v0.1.13.2/tlschecker-macos
