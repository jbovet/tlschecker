...
```sh
docker run josebovet/tlschecker:v0.1.13.1 jpbd.dev
```
...
```sh
curl -LO https://github.com/jbovet/tlschecker/releases/download/v0.1.13.1/tlschecker-linux
...
```sh
curl -LO https://github.com/jbovet/tlschecker/releases/download/v0.1.13.1/tlschecker-macos
